...
<body>
  ...
  <div class="content">
    ...
    <div id="Daily" class="tabcontent">
      ...
      <form method="post" action="daily_inv_all.php" class="form-inline">
    ...
    <div id="Weekly" class="tabcontent">
      ...
      <form method="post" action="weekly_inv_all.php" class="form-inline">
        <div class="form-group">
    ...
    <div id="Monthly" class="tabcontent">
      ...
      <form method="post" action="monthly_inv_all.php" class="form-inline">
        <div class="form-group">
    ...
    <div id="Yearly" class="tabcontent">
      ...
      <form method="post" action="yearly_inv_all.php" class="form-inline">
        <div class="form-group">
