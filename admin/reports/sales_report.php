...
<body>
  ...
  <div class="content">
    <!--TAB-->
    <div class="tab">
      <button class="tablinks" onclick="openType(event, 'Daily')" id="defaultOpen">Daily Sales</button>
      <button class="tablinks" onclick="openType(event, 'Weekly')">Weekly Sales</button>
      <button class="tablinks" onclick="openType(event, 'Monthly')">Monthly Sales</button>
      <button class="tablinks" onclick="openType(event, 'Yearly')">Yearly Sales</button>
    </div>

    <!--DAILY SALES-->
    <div id="Daily" class="tabcontent">
      <h3 id="report-title">Daily Sales Reports</h3>

      <form method="post" action="daily_search_all.php" class="form-inline">
    ...
    <div id="Weekly" class="tabcontent">
      <h3 id="report-title">Weekly Sales Reports</h3>

      <form method="post" action="weekly_search_all.php" class="form-inline">
        <div class="form-group">
    ...
    <div id="Monthly" class="tabcontent">
      <h3 id="report-title">Monthly Sales Reports</h3>
