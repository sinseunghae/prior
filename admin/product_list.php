...
<body>
	...
	<div class="content"><br>
		<div class="container">
			<h1 class="display-5 font-weight-bold text-center" style="color: #053742;">Product List</h1>
		</div><br><br>
			...
			<table border='1'  class="table table-bordered">
				...
				<tbody id="myTable">
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						$product_variations = $row["product_variations"];
						...
						?>
						<tr>
							<td scope='row' class=' text-center'><?= $product_id ?></td>
							...
							<td scope='row' class=' text-center'><?= $reorder_point ?></td>
							<td scope='row' class=' text-center'><?= $barcode ?></td>
							<td scope='row' class=' text-center'><?= $stock_staus ?></td>


							<?php 
							echo "<td class=' text-center'>", "<a href='edit_product.php?product_id=" . $row["product_id"] . "'>", "<button class='btn btn-primary'> Edit</button>","</a>","</td>";
							?>
		...
		<!-- Add -->
		<div align="left">
			<button class="add-btn"><a href="add_product.php">Add Product</a></button>
		</div>
	</body>	
	</html>