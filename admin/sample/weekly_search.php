    ...
    <div class="content">
		...
		<table class="table-bordered">
	      <thead>
	      	...
	      	<tr>
	      		<th colspan="4">Weekly Sales Report</th>
	      	</tr>

	      	<tr>
	      		<th colspan="4" id="left-align">Employee: </th>
	      	</tr>

	      	<tr>
	      		<th colspan="2" id="left-align">Date: <?php echo $date_from; ?> to <?php echo $date_to; ?></th>
	      ...
	      <tbody>
	        <?php 
	          	$result = mysqli_query($con, "SELECT products.product_id, products.prod_name, products.prod_price, sum(sales.quantity) as quantity, sum(sales.total_amount) as total  FROM products, sales WHERE (products.product_id=sales.product_id) and (sales.sales_date between '$date_from' and '$date_to') and (sales.branch_id like '%$branch%') GROUP BY product_id");
	        ...
	        <tfoot>
	            <?php 
	              $result2 = mysqli_query($con, "SELECT sum(total_amount) as total FROM sales WHERE (sales_date between '$date_from' and '$date_to') and (branch_id like '%$branch%')");
	    ...
	    <br />
		<a href="weekly_sales.php" style="text-decoration:none;">
