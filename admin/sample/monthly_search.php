    ...
    <div class="content">
		...
		<table class="table-bordered">
	      ...
	      <tbody>
	        ...
	        <tfoot>
	            <?php 
	              $result2 = mysqli_query($con, "SELECT sum(total_amount) as total FROM sales WHERE (month(sales.sales_date)='$month' and year(sales.sales_date)='$year') and (branch_id like '%$branch%')");
