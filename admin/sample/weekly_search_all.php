		...
		<table class="table-bordered">
	      <thead>
	      	...
	      	<tr>
	      		...
	      		<th colspan="2" id="left-align">Branch: All</th>
	      	</tr>
	      ...
	      <tbody>
	        <?php 
	          	$result = mysqli_query($con, "SELECT products.product_id, products.prod_name, products.prod_price, sum(sales.quantity) as quantity, sum(sales.total_amount) as total  FROM products, sales WHERE (products.product_id=sales.product_id) and (sales.sales_date between '$date_from' and '$date_to') GROUP BY product_id");
	        ...
	        <tfoot>
	            <?php 
	              $result2 = mysqli_query($con, "SELECT sum(total_amount) as total FROM sales WHERE sales_date between '$date_from' and '$date_to'");
