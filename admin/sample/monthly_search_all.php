		...
		<table class="table-bordered">
	      <thead>
	      	...
	      	<tr>
	      		...
	      		<th colspan="4">Sales Report for the Month of <?php echo $newMonth; ?>  <?php echo $year; ?></th>
	      	</tr>
	      ...
	      <tbody>
	        <?php 
	          	$result = mysqli_query($con, "SELECT products.product_id, products.prod_name, products.prod_price, sum(sales.quantity) as quantity, sum(sales.total_amount) as total  FROM products, sales WHERE (products.product_id=sales.product_id) and (month(sales.sales_date)='$month' and year(sales.sales_date)='$year') GROUP BY product_id");
	        ...
	        <tfoot>
	            <?php 
	              $result2 = mysqli_query($con, "SELECT sum(total_amount) as total FROM sales WHERE month(sales.sales_date)='$month' and year(sales.sales_date)='$year'");
