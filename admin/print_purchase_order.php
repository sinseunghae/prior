...
<body>
	...
	<div class="content"><br>
							...
							while ($row = mysqli_fetch_assoc($result)) 
							{
								...
								<table id="salesinfo">
									<thead>
										...
										<tr class="center">
											<th colspan="12">
												<p><h4 class="font-weight-bold" style="color: #053742; text-align: center;">PURCHASE ORDER</h4></p>
											</th>
										</tr>

										<tr id="left">
											<th colspan="4"><p><b>Purchase Order #: </b> PO-<?php echo $row['purchase_ID']; ?></p> </th>
		...
		<div align="right">
			...
			<button class="add-btn"><a href="purchase_order.php">Back</a></button>
		</div>
	</div>
</body>	
</html>
