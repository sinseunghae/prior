...
<body>
	...
	<div class="content"><br>
		<div class="container">
			<h1 class="display-5 font-weight-bold text-center" style="color: #053742;"><b>SALES ORDER</b></h1>
		</div><br><br>
			...
			<table border='1'  class="table table-bordered">
				...
				<tbody id="myTable">
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						?>
						<tr>
							<td scope='row' class=' text-center'>SO-<?= $purchase_ID ?></td>
							...
							<!-- Edit --> 
							<?php 
								echo "<td class=' text-center'>", "<a href='edit_sales_status.php?purchase_id=" . $row["purchase_id"] . "'>", "<button class='add-btn btn '>Edit</button>","</a>","</td>";
								?>

							<!-- View --> 
								<?php 
								echo "<td class=' text-center'>", "<a href='print_sales_order.php?purchase_id=" . $row["purchase_id"] . "'>", "<button class='add-btn btn '>View</button>","</a>","</td>";
								?>
