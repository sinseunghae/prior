...
<main>
  ...
  <div class="nero">
    <div class="nero__heading">
      <span class="nero__bold">Register</span> AT DCDG
    </div>
    <p class="nero__text">
    </p>
  </div>
      ...
      <div class="box" ><!-- box Starts -->
        ...
        <form action="customer_register.php" method="post" enctype="multipart/form-data" ><!-- form Starts -->
          ...
          <div class="form-group" ><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_name" placeholder="Enter your full name..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_username" placeholder="Enter your username..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <div class="input-group"><!-- input-group Starts -->
              ...
              <input type="password" class="form-control" id="pass" name="c_pass" placeholder="Enter your password..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <div class="input-group"><!-- input-group Starts -->
              ...
              <input type="password" class="form-control confirm" id="con_pass" placeholder="Confirm your password..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_city" placeholder="Enter city/ municipality..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_unit" placeholder="Enter your unit/floor/ building..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_house" placeholder="Enter your house/ lot & block..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_street" placeholder="Enter your street..." required>
          ...
          <div class="form-group"><!-- form-group Starts -->
            ...
            <input type="text" class="form-control" name="c_barangay" placeholder="Enter your barangay..." required>
