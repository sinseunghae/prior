	...
	<div class="col-md-9"><!-- col-md-9 Starts -->
		...
		<form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"><!--- form Starts -->
			...
			<div class="text-center"><!-- text-center Starts -->
				...
				<button type="submit" name="confirm_payment" class="btn btn-info shadow-none" style="border-radius: 8px;"">
...
$insert_payment = "insert into payments (invoice_no,amount,payment_mode,ref_no,code,payment_date) values ('$invoice_no','$amount','$payment_mode','$ref_no','$payment_date')";
