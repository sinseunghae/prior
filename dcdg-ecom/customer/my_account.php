    ...
    <div class="container" ><!-- container Starts -->
      ...
      <div class="col-md-12"><!-- col-md-12 Starts -->
        ...
        if(!empty($customer_confirm_code)){
          ...
          <div class="alert alert-warning"><!-- alert alert-danger Starts -->

            <center>
              <strong> Warning! </strong> Please confirm your email, and if you have not received your confirmation email click >
