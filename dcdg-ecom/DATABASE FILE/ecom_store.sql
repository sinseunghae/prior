...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2022 at 01:48 PM
...
CREATE TABLE `customers` (
  ...
  `customer_house` varchar(255) NOT NULL,
...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_email`, `customer_username`, `customer_pass`, `customer_city`, `customer_unit`, `customer_house`, `customer_street`, `customer_barangay`, `customer_contact`, `customer_image`, `customer_ip`, `customer_confirm_code`) VALUES
(2, 'user', 'user@ave.com', 'uwuwuw', '123', 'New York', 'dsxfcgv', 'new york', 'asdsfvgf', 'ascdvfbg', 9054336789, 'user.jpg', '::1', '');
