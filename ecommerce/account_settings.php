        ...
        <form action="/action_page.php" method="post">
          ...
          <tbody>
            <div class="acc-container">
              <tr>
                <th colspan="11">Profile</th>

                <td colspan="1"><p style="text-align:right;"><a href="edit_account_settings.php">Edit</a></p></td>
              </tr>
              ...
              <tr>
                <td colspan="6"><input type="text" value="Juan" name="fname" readonly></td>
                <td colspan="6"><input type="text" value="Dela Cruz" name="lname" readonly></td>
              </tr>
              ...
              <tr>
                <td colspan="6"><input type="email" value="juandcruz@gmail.com" name="txtEmail" id="txtEmail" readonly>
                <td colspan="6"><input type="tel" id="phone" name="phone" value="0912-345-6789" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" readonly></td>
              </tr>
              ...
              <tr>
                <td colspan="6"><input type="password" name="psw" readonly></td>
                <td colspan="6"><input type="password" name="npsw" readonly></td>
              </tr>
            </div>
          </tbody>
        </form>
