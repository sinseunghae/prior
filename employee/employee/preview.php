...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<table cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;width : 100%;">
		...
		<tr style="font:bold 12px 'Lato', sans-serif;">
			<td>OR No. :</td>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;border-bottom: 1px solid black; border-right: 1px solid black; padding: 10px;" width="100%">
		<thead>
			<tr>
